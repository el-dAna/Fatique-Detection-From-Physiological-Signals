...
def delete_experiment_list(task_name:str, experiments_to_delete:list, project_name=str,):
    return delete_experiments(task_name='user delete', experiments_to_delete=['test_ui'])
